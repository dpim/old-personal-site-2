...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"9":"cc857441a550661258b9"}[chunkId] + ".js");
...
/* harmony import */ var _components_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("RSoV");
/* harmony import */ var _components_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("UeDS");
...
const Home = ({
  ...
  return __jsx("div", {
    className: "container"
  }, Object(_components_menu__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])("Dmitry Pimenov"), __jsx("div", {
    className: "grid"
  }, Object(_components_card__WEBPACK_IMPORTED_MODULE_2__[/* DescriptionCard */ "a"])(content)));
};

async function getStaticProps() {
  const content = await __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(null, "QpD1"));
  return {
    props: {
