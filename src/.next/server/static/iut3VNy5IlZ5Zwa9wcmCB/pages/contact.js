...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"10":"2e8cac5425d9efda415a"}[chunkId] + ".js");
...
const Home = ({
  ...
  className: "container"
}, Object(_components_menu__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])("Reach Out"), __jsx("div", {
  className: "grid"
}, Object(_components_card__WEBPACK_IMPORTED_MODULE_2__[/* DescriptionCard */ "a"])(content)));

async function getStaticProps() {
  const content = await __webpack_require__.e(/* import() */ 10).then(__webpack_require__.bind(null, "OQ/A"));
  return {
    props: {
